...
def launch_setup(context, *args, **kwargs):
    ...
    robot_moveit_common_launch = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('my_uf_gazebo'), 'launch', 'support', '_robot_moveit_common2.launch.py'])),
    launch_arguments={
            'prefix': prefix,
            'attach_to': attach_to,
            'attach_xyz': attach_xyz,
            ...
            'rviz_config': PathJoinSubstitution([FindPackageShare('my_uf_gazebo'), 'rviz', 'environment.rviz'])
        }.items(),
    )
    ...
    robot_gazebo_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('my_uf_gazebo'), 'launch', 'support', '_gazebo_ign.launch.py'])),
        launch_arguments={
            'dof': dof,
            'robot_type': robot_type,
            'prefix': prefix,
