...
def launch_setup(context, *args, **kwargs):
    ...
    #moveit_config_package_name = 'my_uf_moveit_config'
    ...
    xarm_gazebo_world = PathJoinSubstitution([FindPackageShare('my_uf_bringup'), 'worlds', 'empty.world'])
    ...
    if not rviz_config.perform(context):
        rviz_config_file = PathJoinSubstitution([FindPackageShare("my_uf_bringup"), 'rviz', 'moveit.rviz'])
    else:
